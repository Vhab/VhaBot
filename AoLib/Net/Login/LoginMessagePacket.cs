...
{
	/// <summary>
	/// Summary description for aoLoginMessage.
	/// </summary>
	internal class LoginMessagePacket : Packet
	{
		...
		internal LoginMessagePacket(): base() {}

		internal LoginMessagePacket(String username, String password, String seed): 
		...
		internal LoginMessagePacket(Packet.Type type, byte[] data): base(type, data) {}
	...
	public class LoginMessageEventArgs : EventArgs
	{
		...
		// Constructor
		public LoginMessageEventArgs(String Seed)
		{
			this._seed = Seed;
		}
