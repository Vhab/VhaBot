...
namespace VhaBot
{
    public class UserLeaveChannelArgs : SenderArgs
    {
        private UInt32 _channelID;
        private string _channel;
        private bool _local;

        public UserLeaveChannelArgs(BotShell bot, UInt32 senderID, string sender, UInt32 channelID, string channel, bool local)
        {
