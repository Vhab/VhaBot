...
namespace VhaBot.Plugins
{
    public class NewsPlugin : PluginBase
    {
        ...
        public override void OnLoad(BotShell bot)
        {
            ...
            /*bot.Configuration.Register(ConfigType.Boolean, this.InternalName, "membjgroup", "Send to member that joins group", false);
            bot.Configuration.Register(ConfigType.Boolean, this.InternalName, "guestjgroup", "Send to guest that joins group", false);
            bot.Configuration.Register(ConfigType.Boolean, this.InternalName, "memblogon", "Send to member that logs on", true);*/
        }
